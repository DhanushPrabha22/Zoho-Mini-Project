...
<header>
	...
	<nav class="navbar navbar-expand-md navbar-dark" style="background-image: linear-gradient(-225deg, #ef9a9a 50%, #78909C 50%)">
...
<div id="mySidenav" class="sidenav" style="background-image: linear-gradient(-225deg, #ef9a9a 65%, #78909C 35%);">
...
<div id="main">
	<div>
		<div class="container1" id="container1">
			<h1 style="font-weight:bold;color:#ef9a9a;">Flagged Tasks</h1>
			<p style="color:#ef9a9a;"><%=currentDate%></p>
			<div>
				<p style="color:#ef9a9a;"><button class="w3-button w3-xlarge w3-circle w3-card-4" style="background-color:#818181;" id="myBtn">+</button>  Add Task...</p>
			</div>
			<div class="taskDiv">
		...
		<div class="container2">
			<div class="details"  style="background:#ef9a9a;">

...
<header>
	...
	<nav class="navbar navbar-expand-md navbar-dark" style="background-image: linear-gradient(-225deg, #e57373 50%, #78909C 50%)">
...
<div id="mySidenav" class="sidenav" style="background-image: linear-gradient(-225deg, #e57373 65%, #78909C 35%);">
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
  <br><br><br><br><br>
  <a href="UserTaskList.jsp" style="color:white;">All Tasks</a>
  <a href="importantTaskList.jsp" style="color:white;">Important Tasks</a>
  <a style="color: #1565C0;">Flagged Tasks</a>
  <a href="#" style="color:white;">Planned</a>
  <a href="#" style="color:white;">Need Attention</a>
</div>
<div id="main">
	<div>
		<div class="container1" id="container1">
			<h1 style="font-weight:bold;color:#e57373;">Flagged Tasks</h1>
			<p style="color:#e57373;"><%=currentDate%></p>
			<br>
			<div>
				<p style="color:#e57373;"><button class="w3-button w3-xlarge w3-circle w3-card-4" style="background-color:#818181;" id="myBtn">+</button>  Add Task...</p>
			</div>
			<div class="taskDiv">
		...
		<div class="container2">
			<div class="details" style="background:#e57373;">
...
<div id="myModal" class="w3-modal">
  	...
  	<div class="w3-modal-content w3-animate-top w3-card-4">
      		<div class="field-set">
				<html:form action="addingTwo" method="post">

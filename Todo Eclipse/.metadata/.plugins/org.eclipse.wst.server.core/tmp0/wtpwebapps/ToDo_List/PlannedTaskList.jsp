...
<header>
	...
	<nav class="navbar navbar-expand-md navbar-dark" style="background-image: linear-gradient(-225deg, #A5D6A7 50%, #78909C 50%)">
...
<div id="mySidenav" class="sidenav" style="background-image: linear-gradient(-225deg, #A5D6A7 65%, #78909C 35%);">
...
<div id="main">
	<div>
		<div class="container1" id="container1">
			<h1 style="font-weight:bold;color:#A5D6A7;">Planned Tasks</h1>
			<p style="color:#A5D6A7;"><%=currentDate%></p>
			<div>
				<p style="color:#A5D6A7;"><button class="w3-button w3-xlarge w3-circle w3-card-4" style="background-color:#818181;" id="myBtn">+</button>  Add Task...</p>
			</div>
			<div class="taskDiv">
		...
		<div class="container2">
			<div class="details"  style="background:#A5D6A7;">
...
<div id="myModal" class="w3-modal">
  	...
  	<div class="w3-modal-content w3-animate-top w3-card-4">
      		<div class="field-set">
				<html:form action="addingThree" method="post">
